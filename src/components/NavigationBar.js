...
function NavigationBar(){
    return (
        <div className="border bg-white shadow text-gray-800">
            <div className="container mx-auto items-center px-4 justify-between flex py-6">
                <ul className="flex items-center">
                    <li>
                        <Link to="/" className="text-2xl fomt-semibold">
                ...
                <div className="ml-auto flex items-center">
                    <input
                        type="text"
                        className="bg-gray-300 rounded-full w-64 py-1 px-2 focus:outline-none "
                        placeholder="Search" />
                </div>
            </div>
        </div>
